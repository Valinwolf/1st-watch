...
static void handle_battery(BatteryChargeState charge_state) {
  static char battery_text[] = "Fully Charged";
...
static void handle_second_tick(struct tm* tick_time, TimeUnits units_changed) {
  ...
  static char s_time_text[] = "00:00:00 AM";
  static char s_date_text[] = "Wednesday, Mar 31";

  strftime(s_time_text, sizeof(s_time_text), "%r", tick_time);
  strftime(s_date_text, sizeof(s_date_text), "%A, %b %e", tick_time);
  text_layer_set_text(s_time_layer, s_time_text);
  text_layer_set_text(s_connection_layer, s_date_text);
}
...
static void main_window_load(Window *window) {
  ...
  text_layer_set_text(s_battery_layer, "Fully Charged");
